        ...
        <article className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
            <section>
                ...
                >
                    ...
                    desenvolvedores são proficientes em tecnologias líderes do
                    setor. Essas escolhas estratégicas não apenas oferecem
                ...
                <section className="mt-12 space-y-12">
                    ...
                    >
                        ...
                        <div className="ml-4">
                            ...
                            <p className="mt-2 ">
                                Nossos algoritmos avançados otimizam suas
                                operações, impulsionando eficiência e
                                lucratividade. Tome decisões orientadas por
                                dados.
                            </p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="ml-4">
                            ...
                            <p className="mt-2 ">
                                Integração de forma contínua tecnologias de
                                ponta como IA, IoT e computação em nuvem.
                                Automatize tarefas, melhore a comunicação e
                    ...
                    >
                        ...
                        <div className="ml-4">
                            ...
                            <p className="mt-2 ">
                                Especialistas treinados garantem implementação
                                tranquila e orientação contínua. Aproveite
                                efetivamente nosso software com assistência
                                personalizada.
                            </p>
                        </div>
                    </motion.div>
                ...
                <div className="mt-12 space-y-12">
                    ...
                    >
                        ...
                        <div className="ml-4">
                            ...
                            <p className="mt-2 ">
                                Especialistas em serviços de otimização para
                                motores de busca (SEO) e publicidade digital,
                                oferecemos soluções integradas para elevar a
                                visibilidade online. Utilizando estratégias de
                                SEO, Google Ads, Facebook Ads e Instagram,
                                garantimos uma presença digital otimizada,
                                aumentando a relevância nos motores de busca,
                                alcançando instantaneamente o público-alvo e
                                expandindo a presença nas redes sociais. Nossa
                                abordagem integrada impulsiona o engajamento, a
                                conversão e o crescimento sustentável para os
                    ...
                    >
                        ...
                        <div className="ml-4">
                            ...
                            <p className="mt-2 ">
                                ...
                                personalizadas, sob medida para atender às suas
                                necessidades exclusivas. Alcance um crescimento
                                sustentável alinhado aos seus objetivos
                                comerciais
                            </p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="ml-4">
                            ...
                            <p className="mt-2 ">
                                Mantenha-se à frente com as últimas
                                características e funcionalidades, garantindo
                                sua relevância no mercado dinâmico. Adapte-se às
                                mudanças nos motores de busca e conquiste uma

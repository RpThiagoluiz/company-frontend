      ...
      <article className="p-8 md:p-24  min-h-screen">
         ...
         <div className="grid grid-cols-1 gap-x-6 gap-y-16 md:grid-cols-2 xl:grid-cols-3">
            ...
            >
               ...
               <p className="mt-10 text-white">
                  Desenvolvemos soluções móveis eficientes e abrangentes. Em
                  todas as plataformas, iOS e Android.
               </p>
            </motion.section>
            ...
            >
               ...
               <p className="mt-10 text-white">
                  ...
                  estratégias de tráfego pago, utilizando ferramentas de ponta
                  como Google Ads, Instagram e Facebook ads para impulsionar seu
                  crescimento.
               </p>
            </motion.section>
            ...
            >
               ...
               <p className="mt-10 text-white">
                  Otimizamos sua presença online com estratégias de tráfego
                  orgânico, fortalecendo a visibilidade e a reputação da sua
                  empresa.
               </p>
            </motion.section>
         </div>

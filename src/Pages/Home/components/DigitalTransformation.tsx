            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-16 md:grid-cols-2 xl:grid-cols-3">
                ...
                >
                    ...
                    <p className="mt-10 text-white">
                        Criamos sites de alta qualidade, garantindo uma
                        experiência responsiva excepcional para seus usuários.
                    </p>
                </motion.section>
                ...
                >
                    ...
                    <p className="mt-10 text-white">
                        Potencializamos a visibilidade online da sua empresa com
                        estratégias de tráfego pago, utilizando ferramentas de
                        ponta como Google Ads, Instagram e Facebook ads para
                ...
                >
                    ...
                    <p className="mt-10 text-white">
                        Otimizamos sua presença online com estratégias de
                        tráfego orgânico, fortalecendo a visibilidade e a
                ...
                >
                    ...
                    <p className="mt-10 text-white">
                        Desenvolvemos soluções móveis eficientes e abrangentes.
                        Em todas as plataformas, iOS e Android.
                    </p>
                </motion.section>
                ...
                >
                    ...
                    <p className="mt-10 text-white">
                        Contamos com uma equipe especializada para criar designs
                        envolventes e intuitivos, aprimorando a experiência do
                        usuário.
                    </p>
                </motion.section>
            </div>

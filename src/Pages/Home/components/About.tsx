         ...
         <section className="flex flex-col-reverse md:flex-row md:h-[25rem] gap-20 my-5">
            ...
            <section className="flex flex-col gap-12 md:gap-0 justify-around">
               ...
               >
                  ...
                  impressionantes até sistemas complexos como painéis
                  administrativos, e-commerce, catálogos online e aplicativos
                  intuitivos. Com expertise em Search Engine Optimization (SEO)
                  e Google Ads, garantimos que sua empresa seja encontrada e se
                  destaque na web.
               </motion.p>
               <Link to="/about">

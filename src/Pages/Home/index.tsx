            ...
            <section className="relative flex justify-around bg-zinc-100 rounded-lg">
               <div className="flex flex-col justify-center gap-7 p-10">
                  ...
                  <p className="w-2/3">
                     ...
                     impulsionar o seu crescimento. Entre em contato agora para
                     estratégias personalizadas e soluções que elevam seu
                     sucesso. Não perca tempo, transforme suas metas em
                     realidade contate-nos para uma parceria de sucesso!
                  </p>
